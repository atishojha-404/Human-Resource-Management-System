...
class="well form-horizontal" method="POST" modelAttribute="newUser" action="newUser"  id="contact_form">
<!-- Text input-->


<!-- Form Name -->
<Form:legend><center><h2><b>Employee - Personal Information - Edit Form</b></h2></center></Form:legend><br>
...
<Form:legend><center><h3><b>Personal Information Form</b></h3></center></Form:legend><br>
