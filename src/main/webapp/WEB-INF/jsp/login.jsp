...
<head>
    ...
    <!--Title Name-->
    <title>Synergy Automation And Instrumentation : LogIn Page</title>
        ...
        <div id="formContent">
          ...
          <h2 class="active"> Sign In </h2>
            ...
            <div class="fadeIn first">
                <img src="${pageContext["request"].contextPath}/resources/image/synergylogo.png" alt="LOGO" style="height: 185px;">
            </div>
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
              <a class="underlineHover" href="login">Welcome to Synergy Automation And Instrumentation LogIn Page</a>
            </div>
